...
function createMap(div, dtId) {
    ...
    // UV resources layer
    var uvresLayer = L.tileLayer.betterWms('https://3-120-5-41.sslip.io:8443/geoserver/uv-moscow/wms?', {
        name: 'uvres',
    ...
    // QER layer
    var qerLayer = L.tileLayer.betterWms('https://3-120-5-41.sslip.io:8443/geoserver/uv-moscow/wms?', {
        name: 'qer',
