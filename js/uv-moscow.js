...
function createMap(div, dtId) {
    ...
    // WMS layers
    // UV index layer
    var uvindexLayer = L.tileLayer.betterWms('http://3.120.5.41:8080/geoserver/uv-moscow/wms?', {
        name: 'uvindex',
    ...
    // UV resources layer
    var uvresLayer = L.tileLayer.betterWms('http://3.120.5.41:8080/geoserver/uv-moscow/wms?', {
        name: 'uvres',
    ...
    // QER layer
    var qerLayer = L.tileLayer.betterWms('http://3.120.5.41:8080/geoserver/uv-moscow/wms?', {
        name: 'qer',
